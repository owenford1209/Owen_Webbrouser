...
const RegisterForm = ({ onToggle }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Commented out all register logic for homepage-only flow
    // const userData = {
    //   name: formData.name,
  ...
  // Commented out the return statement to disable the component
  // return (
  ...
  //           Join the Iowa Dashboard community
  //         </p>
  //       </div>
  ...
  //           Provide either email or phone number (or both) to create your account.
  //         </div>
